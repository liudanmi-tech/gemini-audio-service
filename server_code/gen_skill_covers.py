...
ASIAN_TAG = "所有人物均为东亚面孔（中国人/日本人/韩国人），黑色直发，五官清秀。"
...
TARGETS = [
    {
        ...
        "image_prompt": (
            ASIAN_TAG +
            "一位年轻中国职场男性站在宽敞的现代办公室中，手持一份精心准备的汇报方案，"
            "自信地面对坐在大班台后的成熟中年上司。上司微微前倾、神情认真。"
    ...
    },
    {
        ...
        "image_prompt": (
            ASIAN_TAG +
            "一位中年亚洲女性领导者站在白板前，面对三位充满活力的年轻亚洲团队成员。"
